...
def build_document():
    ...
    add_bullets(doc, [
        ...
        "C: 드라이브의 여유 공간과 C:\\SOFCMeas\\Data, C:\\CSEng\\TrimForm\\LOG 폴더 접근 여부를 확인합니다.",
    ...
    add_table(doc, ["항목", "내용"], [
        ["기본 위치", "C:\\CSEng\\TrimForm\\LOG\\yyyy\\MM\\dd"],
    ...
    add_callout(doc, "관리자 전달 정보", "발생 날짜와 시각, 설비 번호, LOT NO., 화면 메시지, 재현 순서, C:\\CSEng\\TrimForm\\LOG의 해당 날짜 폴더, 관련 CSV 파일을 함께 전달하십시오.")
    ...
    add_table(doc, ["용도", "경로"], [
        ...
        ["응용 프로그램 로그", "C:\\CSEng\\TrimForm\\LOG\\yyyy\\MM\\dd"],
        ["설정", "C:\\SOFCMeas\\Conf"],
