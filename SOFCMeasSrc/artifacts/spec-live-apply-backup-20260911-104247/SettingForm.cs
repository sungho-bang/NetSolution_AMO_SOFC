...
namespace SOFCMeas
{
    public class SettingForm : Form
    {
        ...
        public SettingForm()
        {
            ...
            footer.Controls.Add(new Label { Dock = DockStyle.Fill, Text = "SAVE 후 시뮬레이션은 다음 START부터, 다른 설정은 재시작 후 적용됩니다. X: 샘플 횟수 / Y: 하중(kgf).", TextAlign = ContentAlignment.MiddleLeft });
            ...
            save.Click += delegate
            {
                try { SaveValues(); MessageBox.Show(this, "설정을 저장했습니다. 시뮬레이션은 다음 START부터, 다른 설정은 재시작 후 적용됩니다.", "저장 완료", MessageBoxButtons.OK, MessageBoxIcon.Information); }
