...
class PlcSettingsSmoke {
 ...
 Environment.SetEnvironmentVariable("SOFCMEAS_ROOT",root); Directory.CreateDirectory(Path.Combine(root,"conf"));
 string path=Path.Combine(root,"conf","SOFCMeas.config");
