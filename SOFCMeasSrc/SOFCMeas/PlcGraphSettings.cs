...
namespace SOFCMeas
{
    internal sealed class PlcGraphSettings
    {
        ...
        internal int PostStopReadMilliseconds { get; private set; }
        ...
        internal static PlcGraphSettings Load(int stationNumber, string defaultIpAddress)
        {
            ...
            var result = new PlcGraphSettings
            {
                ...
                Port = ReadInt(stationPrefix + "Plc.Port", 5000, 1, 65535),
                ...
                PostStopReadMilliseconds = ReadInt(stationPrefix + "Plc.PostStopReadMs", 2000, 0, 60000),
