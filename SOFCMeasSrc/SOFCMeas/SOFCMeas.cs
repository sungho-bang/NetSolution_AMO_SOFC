    ...
    public partial class SOFCMeas : Form
    {
        ...
        private void LogStationSettings(PlcGraphSettings settings)
        {
            m_ApplicationLogService.Info(
                ...
                string.Format(
                    ...
                    "pollMs={4} postStopReadMs={5} reconnectMs={6} timeoutMs={7} loadScale={8:0.######} " +
                    "maxGraphPoints={9} requestDevice={10} startValue={11} endValue={12} " +
                    "loadRaw={13} loadWords=5 loadFormat=ASCII_STX_HEADER_SIGN_MAGNITUDE_ETX",
        ...
        private async void SOFCMeas_Shown(object sender, EventArgs e)
        {
            m_ApplicationLogService.Info(
                ...
                string.Format(
                    CultureInfo.InvariantCulture,
                    "event=APPLICATION_STARTED product=SOFCMeas version={0} " +
                    "machine=\"{1}\" os=\"{2}\" process64Bit={3} clr=\"{4}\"",
